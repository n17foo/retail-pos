...
type MoreMenuItem = 'DailyOrders' | 'Settings' | 'Users' | 'Refund' | 'Printer' | 'PaymentTerminal';
...
const MORE_MENU_ACCESS: Record<UserRole, MoreMenuItem[]> = {
  admin: ['DailyOrders', 'Settings', 'Users', 'Refund', 'Printer', 'PaymentTerminal'],
  manager: ['DailyOrders', 'Settings', 'Refund', 'Printer', 'PaymentTerminal'],
  cashier: ['DailyOrders', 'Printer', 'PaymentTerminal'],
};
